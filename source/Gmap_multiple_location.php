...
console.log(result);
var result=JSON.stringify($('#my-form').serializeObject());
var obj = jQuery.parseJSON(result);
var vehicles=obj.id;
console.log(vehicles);
if(vehicles==undefined)
{
jAlert('Please Select Vehicle', 'Alert');return false;
}
/*var result=JSON.stringify($('#my-form').serializeObject());
var obj = jQuery.parseJSON(result);
console.log(obj);*/
...
/*$form = $('form');
   $form.submit(function(){
      $.get($(this).attr('action'), $(this).serialize(), function(response){
          console.log(response);  // do something here on success
      },'json');
      return false;
   });*/
  //function initialize() {
...
var result=JSON.stringify($('#my-form').serializeObject()); 
var obj = jQuery.parseJSON(result);
var markoff=$.getValues('web_services/location.php?option=9&list=obj.id');
console.log(markoff);
	...
	//console.log(vehicles);
	//console.log(jQuery.parseJSON( vehicles ));
    	var result = null;
	
    	$.ajax({
        url: url+'&list='+vehicles,
        type: 'get',
	//data:"list=143,142,141",
        dataType: 'json',
        async: false,
...
//console.log(obj.id);
var markers=$.getValues("web_services/location.php?option=9");
console.log(markers);
...
<!--<body onload="initialize()"> -->
	...
	<div id='console' style="width: 285px; height: 715px;">
		...
		<div class='navbox' style="height: 150px;">
			<ul class='nav'>
				<li><a href="javascript:void(0)" onclick="location.href='Gmap_location.php'">Home</a></li>
				<li><a href="javascript:void(0)" onclick="location.href='Gmap_multiple_location.php'" style="background: url('images/inside_ui/image_0005_Layer-4-copy-6.png') no-repeat">Selective Live Monitor</a></li>
				...
				<li><a href="javascript:void(0)" onclick="location.href='log_out.php'">Logout</a></li>
					...
					<div id='form_wrapper'><h5 style="clear: both; text-align: center;">Hold Control key for multiple vehicle(s) selection</h5>
						<!--<form method="get" name="frm">-->
						<form id="my-form"/>
							<select MULTIPLE name="id" id="vehicle">
                						<!--<option value="this.value">Select your vehicle</option>-->
           					 	</select>
					</form> <br>
	<span style="margin-left: 90px;"> <input id="calls" type="submit" value="submit"/> </span>
						
					</div>	
	
	<h3 style="text-align: center;">click on any of the markers to open info window</h3>
					

				
		
	</div>
	<div id="map_canvas" ><div id="initial"><script>jAlert('Hold Control key for multiple vehicle(s) selection','Alert')</script></div></div>  
