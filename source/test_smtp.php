 ...
 */
  ...
  /* Uncomment when using SASL authentication mechanisms */
	...
	*/
	...
	$from="nuthan@directkarma.com";                           /* Change this to your address like "me@mydomain.com"; */ $sender_line=__LINE__;
	$to="nuthankumarns@gmailcom";                             /* Change this to your test recipient address */ $recipient_line=__LINE__;
	...
	$smtp->host_name="relay-hosting.secureserver.net";       /* Change this variable to the address of the SMTP server to relay, like "smtp.myisp.com" */
	...
	$smtp->localhost="www.tritonetech.com";       /* Your computer address */
