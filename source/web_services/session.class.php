...
class Session {
 ...
 $this->mysql = mysql_connect('localhost', 'nuthan', 'tritone123');
        $bSeldb = mysql_select_db('vts', $this->mysql);
...
@mysql_query("SET character_set_results=utf8");
    ...
    public function write($id, $data) {
        ...
        $sql = "REPLACE INTO user_sessions VALUES  ('$id', '$access', '$data')";
	...
	public function users() {
        $sql = "SELECT COUNT(id) FROM user_sessions";
